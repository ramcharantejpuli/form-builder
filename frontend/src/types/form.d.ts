export type FieldType = 'text' | 'textarea' | 'number' | 'email' | 'tel' | 'date' | 'time' | 'checkbox' | 'select' | 'radio' | 'file' | 'url';
...
export type ValidationRuleType = 'required' | 'email' | 'url' | 'pattern' | 'minLength' | 'maxLength' | 'min' | 'max' | 'custom';
